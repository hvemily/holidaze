  ...
  return (
    <footer className="bg-holi-nav text-white">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-10 sm:px-6 md:grid-cols-3 lg:px-8">
        ...
        <nav aria-label="Footer" className="md:justify-self-center">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li>
              <Link to="/" className="underline-offset-4 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-white/60">
                Home
              </Link>
            </li>
            <li>
              <Link to="/venues" className="underline-offset-4 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-white/60">
                Venues
              </Link>
            </li>
            <li>
              <Link to="/register" className="underline-offset-4 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-white/60">
                Register
              </Link>
            </li>
            <li>
              <Link to="/login" className="underline-offset-4 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-white/60">
                Login
              </Link>
            </li>
          </ul>
      ...
      <div className="border-t border-white/20">
        <div className="mx-auto flex max-w-7xl justify-between px-4 py-4 text-xs text-gray-200 sm:px-6 lg:px-8">
          <span>© {year} Holidaze. All rights reserved.</span>
          <span>
